	...
	protected function change_list_value($field_info, $value = null)
	{
		...
		switch ($real_type) {
			...
			case 'datetime':
				...
				{
					list($year,$month,$day) = explode("-",$value);
					list($hours,$minutes,$second) = explode(":",substr($value,11));

					$value = date($this->php_date_format." - H:i:s", mktime ((int)$hours , (int)$minutes , (int)$second, (int)$month , (int)$day ,(int)$year));
				}
				else
				{
					$value = '';
