...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">Antrian Klinik Pratama Seger</a>
  ...
  <header class="masthead bg-primary text-white text-center">
    <div class="container d-flex align-items-center flex-column">
      ...
      <!-- Masthead Heading -->
      <h1 class="masthead-heading text-uppercase mb-0"><img class="masthead-avatar mb-5" src="<?php echo base_url('assets/user') ?>/img/klinik.png" alt="">Klinik Pratama Seger</h1>
      <!-- <div class="row">
      ...
      <?php if(!empty($this->session->userdata('id_pasien'))){ ?>
        <div class="row" style="margin-top: 60px">
          <div class="col-md-3" style="border: thin solid; ">
            <h3><?php echo $poli_dalam; ?></h3>
            <H6>Poli Penyakit Dalam</H6>
          </div>
          <div class="col-md-3" style="border: thin solid; ">
            <h3><?php echo $poli_spesialis_jantung; ?></h3>
            <H6>Poli Spesialis Jantung</H6>
          </div>
          
          <div class="col-md-3" style="border: thin solid; ">
            <h3><?php echo $poli_spesialis_mata; ?></h3>
            <H6>Poli Spesialis Mata</H6>
          </div>

          <div class="col-md-3" style="border: thin solid; ">
            <h3><?php echo $poli_spesialis_kandungan; ?> 
            <H6>Poli Spesialis Kandungan</H6>
          </div>

          <div class="col-md-3" style="border: thin solid; ">
            <h3><?php echo $poli_spesialis_tht; ?>
            <H6>Poli Spesialis THT - KL</H6>
          </div>

          <div class="col-md-3" style="border: thin solid; ">
            <h3><?php echo $poli_spesialis_gigi; ?>
            <H6>Poli Gigi</H6>
          </div>
        </div>
      <?php } ?>
      <?php if(empty($this->session->userdata('id_pasien'))){ ?>
        <h4 class="masthead mb-0" style="margin-top: 10px !important;padding: 20px;">Selamat Datang di Klinik Pratama Seger. 
        <br> Jika anda belum memiliki akun, silakan Registrasi terlebih dahulu.</h4>
        <div class="d-flex">
          <button type="button" class="btn btncostume m-1" data-toggle="modal" data-target="#exampleModal">
            Registrasi
          </button>
          <button type="button" class="btn btncostume m-1" data-toggle="modal" data-target="#exampleModal2">
            Reset
          </button>
        </div>
      <?php } ?>
            ...
            <div class="row justify-content-md-center">
              <div class="col-md-4" style="margin-top: 20px">
                ...
                <form action="<?php echo base_url('Index/proses_login') ?>" method='post'>
                  ...
                  <input maxlength="6" type="password" name="password" class="form-control">
                  <br><br>
            ...
            <div class="row justify-content-md-center">
              <div class="col-md-12" style="margin-top: 20px">
                ...
                <form action="<?php echo base_url('Index/saveAntrian') ?>" method="post">
                  <div class ="row">
                    ...
                    <div class="col-md-5">
                      <select name="id_poli" id="id_poli" class="form-control" onchange="noAntrian(this.value)">
                        ...
                        ?>
                          <option value="<?php echo $row->id_poli; ?>"> <?php echo $row->kode_poli; ?>  ( <?php echo $row->nama_poli; ?>  )</option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
                 ...
                 <h6>Keterangan:</h6>
                  <ol>
                    <li>Poli Spesialis Kandungan(PLKD)</li>
                    <li>Poli Gigi (PLGG) </li>
                    <li>Poli Spesialis THT - K (PLTH)</li>
                    <li>Poli Spesialis Mata (PLMT)</li>
                    <li>Poli Spesialis Jantung (PLJG)</li>
                    <li>Poli Penyakit Dalam (PLPM)</li>
                  </ol>
              </div> -->
              </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 mb-5 mb-lg-0">
          ...
          <p class="lead mb-0">Jalan Wahid Hasyim 
            <br>No.24, Jombang, Jawa Timur, Indonesia</p>
        </div>
        ...
        <div class="col-lg-6">
          ...
          <p class="lead mb-0">+62 878-1148-1227</p>
        </div>
  ...
  <section class="copyright py-4 text-center text-white">
    <div class="container">
      <small>&copy;Klinik Pratama Seger </small>
    </div>
  </section>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url('Index/registrasi') ?>" method="post">
            ...
            <div>
                <label >Umur <sup>*</sup></label>
                <input type="text" id="umur" name="umur" class="form-control" value="" placeholder="Masukkan Umur" required="">
            </div>
            ...
            <div>
                ...
                <input type="password" maxlength="6" id="password" name="password" class="form-control" value="" placeholder="Password" required="">
            </div>
...
<div class="modal fade bd-example-modal-lg" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url('Index/reset') ?>" method="post">
            <div>
                <label >Username <sup>*</sup></label>
                <input type="text" id="username" name="username" class="form-control" value="" placeholder="Username" required="">
            </div>
